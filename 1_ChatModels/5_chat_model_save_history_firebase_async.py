...
async def main():
    ...
    # Chat Loop (Non-async part)
    # Note: For simplicity, we're keeping this part non-async
    # In a more advanced implementation, you might want to make the input/output async too
    while True:
    ...
    # Correctly using the async method
